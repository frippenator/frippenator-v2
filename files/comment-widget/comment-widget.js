...
const s_stylePath = '../files/comment-widget/comment-widget-dark.css';
const s_formId = '1FAIpQLSfN9V95BWmLty8JCJNUSBwD0-ypWkl_2WLlmRQcvYDYxwaDkw';
const s_nameId = '997258014';
const s_websiteId = '1205796649';
const s_textId = '1884857973';
const s_pageId = '287119758';
const s_replyId = '1272985856';
const s_sheetId = '1yvGo7nieNsNR6x7DBf4PVybgmETUdZDNgNOaR91Qzbk';

// The values below are necessary for accurate timestamps, I've filled it in with EST as an example
const s_timezone = -6; // Your personal timezone (Example: UTC-5:00 is -5 here, UTC+10:30 would be 10.5)
...
const s_submitButtonLabel = 'post';
const s_loadingText = 'Loading...';
const s_noCommentsText = 'A tumbleweed crosses the road...';
const s_closedCommentsText = 'Comments closed for now.';
